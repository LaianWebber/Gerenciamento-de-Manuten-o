        ...
        .then(tarefas => {
            if (tarefas.length === 0) {
                ...
                tarefas.forEach(tarefa => {
                    ...
                    if (tasks) {
                        let htmlTask = `<tr>
                                        <td class="tarefas">📺<a href="../pages/infoTask.html" onclick="storeTaskId(${tarefa.id})">${tarefa.task_title}</a></td>
                    ...
                    if (containerFazer) {
                        if (tarefa.task_status === "a fazer") {
                            let htmlTaskQuadroFazer = `
                                <div class="taskFazer">
                                    <h2 class="tarefas">📺<a href="../pages/infoTask.html" onclick="storeTaskId(${tarefa.id})">${tarefa.task_title}</a></h2>
                                    <h2 class="responsavel"><a href="#">${tarefa.task_respon}</a></h2>
